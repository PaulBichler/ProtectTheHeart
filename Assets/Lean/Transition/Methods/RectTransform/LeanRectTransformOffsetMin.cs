...
namespace Lean.Transition.Method
{
    ...
    public class LeanRectTransformOffsetMin : LeanMethodWithStateAndTarget
    {
        ...
        public class State : LeanStateWithTarget<TARGET>
        {
            ...
            [Tooltip("The offsetMin value will transition to this.")] [FormerlySerializedAs("OffsetMin")] public
                Vector2 Value;
            ...
            {
                Target.offsetMin = Vector2.LerpUnclamped(oldValue, Value, Smooth(Ease, progress));
            }
...
namespace Lean.Transition
{
    ...
    {
        public static TARGET offsetMinTransition(this TARGET target, Vector2 value, float duration,
            LeanEase ease = LeanEase.Smooth)
        {
            LeanRectTransformOffsetMin.Register(target, value, duration, ease);
            return target;
        }
    }
}