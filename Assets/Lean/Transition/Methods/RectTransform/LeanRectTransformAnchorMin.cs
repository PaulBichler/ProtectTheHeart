...
namespace Lean.Transition.Method
{
    ...
    public class LeanRectTransformAnchorMin : LeanMethodWithStateAndTarget
    {
        ...
        public class State : LeanStateWithTarget<TARGET>
        {
            ...
            [Tooltip("The anchorMin value will transition to this.")] [FormerlySerializedAs("AnchorMin")] public
                Vector2 Value;
            ...
            {
                Target.anchorMin = Vector2.LerpUnclamped(oldValue, Value, Smooth(Ease, progress));
            }
...
namespace Lean.Transition
{
    ...
    {
        public static TARGET anchorMinTransition(this TARGET target, Vector2 value, float duration,
            LeanEase ease = LeanEase.Smooth)
        {
            LeanRectTransformAnchorMin.Register(target, value, duration, ease);
            return target;
        }
    }
}