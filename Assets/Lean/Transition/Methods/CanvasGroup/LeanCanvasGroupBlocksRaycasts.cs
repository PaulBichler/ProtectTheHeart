...
namespace Lean.Transition.Method
{
    ...
    [AddComponentMenu(
        ...
        "CanvasGroup/CanvasGroup.blocksRaycasts" +
        LeanTransition.MethodsMenuSuffix +
        "(LeanCanvasGroupBlocksRaycasts)")]
    public class LeanCanvasGroupBlocksRaycasts : LeanMethodWithStateAndTarget
    {
        ...
        public class State : LeanStateWithTarget<TARGET>
        {
            ...
            [Tooltip("The blocksRaycasts value will transition to this.")] [FormerlySerializedAs("BlocksRaycasts")] public bool Value = true;
