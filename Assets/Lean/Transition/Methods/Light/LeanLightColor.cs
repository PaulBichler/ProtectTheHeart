...
{
    /// <summary>This component allows you to transition the Light's color value.</summary>
    [HelpURL(LeanTransition.HelpUrlPrefix + "LeanLightColor")]
    [AddComponentMenu(
        LeanTransition.MethodsMenuPrefix + "Light/Light.color" + LeanTransition.MethodsMenuSuffix + "(LeanLightColor)")
    ]
...
namespace Lean.Transition
{
    public static partial class LeanExtensions
    {
        ...
        {
            LeanLightColor.Register(target, value, duration, ease);
            return target;
        }
    }
}