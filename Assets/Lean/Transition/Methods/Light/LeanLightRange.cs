...
namespace Lean.Transition.Method
{
    ...
    [AddComponentMenu(
        LeanTransition.MethodsMenuPrefix + "Light/Light.range" + LeanTransition.MethodsMenuSuffix + "(LeanLightRange)")
    ]
    public class LeanLightRange : LeanMethodWithStateAndTarget
    {
        ...
        public class State : LeanStateWithTarget<TARGET>
        {
            ...
            [Tooltip("The range value will transition to this.")] [FormerlySerializedAs("Range")] public float Value =
                1.0f;
