...
namespace Lean.Transition.Method
{
    ...
    public class LeanTransformTranslate : LeanMethodWithStateAndTarget
    {
        ...
        public class State : LeanStateWithTarget<Transform>
        {
            ...
            [Tooltip("The amount we will translate.")] public Vector3 Translation;

            [Tooltip("The space we will transition in.")] public Space Space = Space.Self;

            [Tooltip("The space we will transition in.")] public Transform RelativeTo;
            ...
            {
                Vector3 newTranslation = Translation * Smooth(Ease, progress);
