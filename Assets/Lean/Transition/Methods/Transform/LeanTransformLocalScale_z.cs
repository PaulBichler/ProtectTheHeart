...
namespace Lean.Transition.Method
{
    ...
    public class LeanTransformLocalScale_z : LeanMethodWithStateAndTarget
    {
        ...
        public class State : LeanStateWithTarget<TARGET>
        {
            ...
            public override int CanFill => Target != null && Target.localScale.z != Value ? 1 : 0;
...
namespace Lean.Transition
{
    ...
    {
        public static TARGET localScaleTransition_z(this TARGET target, float value, float duration,
            LeanEase ease = LeanEase.Smooth)
        {
            LeanTransformLocalScale_z.Register(target, value, duration, ease);
            return target;
        }
    }
}