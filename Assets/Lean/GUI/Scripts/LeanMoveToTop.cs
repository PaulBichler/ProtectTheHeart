...
{
	/// <summary>
	///     This component will automatically move the specified transform to be the first sibling when you press down on
	///     this UI element.
	/// </summary>
    ...
    public class LeanMoveToTop : MonoBehaviour, IPointerDownHandler
    {
        ...
        private static readonly List<LeanMoveToTop> tempOthers = new List<LeanMoveToTop>();
        [SerializeField] private MoveType move;
        ...
        public void OnPointerDown(PointerEventData eventData)
        {
            switch (move)
            {
                ...
                case MoveType.ParentComponents:
                {
                    ...
                    foreach (LeanMoveToTop other in tempOthers)
