...
namespace Lean.Gui
{
    ...
    public class LeanTooltipData : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler, IPointerDownHandler,
        IPointerUpHandler
    {
	    ...
	    /// <summary>
	    ///     If you want this tooltip to hide when a selectable (e.g. Button) is disabled or non-interactable, then specify
	    ///     it here.
	    /// </summary>
        ...
        protected virtual void Update()
        {
            if (LeanTooltip.HoverData == this)
                if (selectable != null)
                    LeanTooltip.HoverShow = selectable.enabled && selectable.interactable;
        }
