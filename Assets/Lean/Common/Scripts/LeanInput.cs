...
namespace Lean.Common
{
	...
	public static class LeanInput
    {
        ...
        {
#if ENABLE_INPUT_SYSTEM
            ButtonControl buttonControl = GetButtonControl(oldKey);
        ...
        {
#if ENABLE_INPUT_SYSTEM
            ButtonControl buttonControl = GetMouseButtonControl(index);
            return buttonControl != null ? buttonControl.wasPressedThisFrame : false;
#else
...
#if ENABLE_INPUT_SYSTEM
        private static readonly Dictionary<KeyCode, NewCode> keyMapping = new Dictionary<KeyCode, NewCode> {
            {
